...
if __name__ == '__main__':
    ...
    department_data['index_in_order_history'] = department_data['index_in_order_history'].fillna(0).astype(str)
    for i, row in department_data.iterrows():
        ...
        order_number_history[i, :], _ = pad_1d(list(map(int, row['days_since_prior_order_history'].split())), 100)
